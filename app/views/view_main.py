...
>>>>>>> menu
    ...
    def initEditor(self):
        ...
        self.m_auinotebook1 = wx.aui.AuiNotebook(
            self, wx.ID_ANY, wx.DefaultPosition, wx.Size(550, -1), wx.aui.AUI_NB_DEFAULT_STYLE)
        ...
        self.m_propertyGridManager1 = pg.PropertyGridManager(
            self, wx.ID_ANY, wx.DefaultPosition, wx.Size(130, 200), wx.propgrid.PGMAN_DEFAULT_STYLE)
